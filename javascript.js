...
const firstQuestion = prompt('What is your first name?');

// 3. Add a second a prompt dialog to capture input from the user and store it in a second variable

const secondQuestion = prompt('What is your last name?');
...
alert(`The string '${stringValue}' is ${totalNumber} number of characters long.`);
